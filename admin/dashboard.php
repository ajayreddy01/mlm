                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 mb-6">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        <h6 class="card-title fw-normal m-0 me-2">Total Withdrawals</h6>
                                        <div class="dropdown">
                                            <button class="btn btn-text text-muted p-0" type="button"
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <h4 class="card-title mb-0" id="totalWithdrawalsValue">₹0</h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 mb-6">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        <h6 class="card-title fw-normal m-0 me-2">Lottery Withdrawals</h6>
                                        <div class="dropdown">
                                            <button class="btn btn-text text-muted p-0" type="button"
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <h4 class="card-title mb-0" id="lotteryWithdrawalsValue">₹0</h4>
                                    </div>
                                </div>
                            </div>
