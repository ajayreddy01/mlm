...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            <h5 class="card-header pb-0 text-md-start text-center">Deposits</h5>
                            <div class="card-datatable table-responsive">
                                <table class="dt-responsive table border-top" id="deposit_table">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th>S.no</th>
    ...
    <script src="<?php echo BASE_URL ?>/assets/js/deposit.js?14"></script>
