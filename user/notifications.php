...
<head>
  ...
  <title>Notifications - Agri Invest</title>
...
<body class="bg-gray-100 dark:bg-gray-900 min-h-screen flex text-gray-900 dark:text-gray-100">
  ...
  <main class="flex-1 md:ml-64 p-4 sm:p-6">
    ...
    <header class="flex items-center justify-between mb-6 relative">
      <div class="flex items-center gap-4">
        ...
        <h1 class="text-xl font-bold text-green-800 dark:text-green-300">Notifications</h1>
      </div>
      <div class="flex items-center gap-4">
  ...
  <!-- Notifications List -->
  <main class="flex-1 p-6 max-w-3xl mx-auto space-y-4">
    <!-- Notification Item -->
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-4 flex items-start gap-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
      <div class="text-2xl">💰</div>
      <div>
        <p class="text-gray-700 dark:text-gray-300 font-medium">You received ₹500 in Wallet</p>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-4 flex items-start gap-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
      <div class="text-2xl">✅</div>
      <div>
        <p class="text-gray-700 dark:text-gray-300 font-medium">Task <span class="italic">"Water wheat field"</span> is pending</p>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-4 flex items-start gap-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
      <div class="text-2xl">🎁</div>
      <div>
        <p class="text-gray-700 dark:text-gray-300 font-medium">Lucky Draw #124124 starts today</p>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-4 flex items-start gap-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
      ...
      <div>
        <p class="text-gray-700 dark:text-gray-300 font-medium">Update your bank account details</p>
