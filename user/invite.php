  ...
  <main class="flex-1 md:ml-64 p-4 sm:p-6">
    ...
    <header class="flex items-center justify-between mb-6 relative">
      <div class="flex items-center gap-4">
        ...
        <h1 class="text-xl font-bold text-green-800 dark:text-green-300">Refer & Earn</h1>
      </div>
      <div class="flex items-center gap-4">
    ...
    <section class="p-4 sm:p-6">
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 overflow-x-auto">
        <h2 class="text-lg font-semibold text-green-700 dark:text-green-300 mb-4">📋 Referral History</h2>
